...
def imageDataToArray(imageData):
    ...
    xlen = imageData[iWIDTH] * 3 # Times 3, because there is r, g and b for each pixel
...
if __name__ == '__main__':
    ...
    # times = timeit.Timer('colorDataToMapFile([(255,0,0, 0,255,0, 0,0,255), (128,0,0, 0,128,0, 0,0,128)], "swatch.png")', "from __main__ import colorDataToMapFile").repeat(repeat=5000, number=1)
